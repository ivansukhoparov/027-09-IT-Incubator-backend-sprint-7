...
export class InitBloggersDB1720306663437 implements MigrationInterface {
    name = 'InitBloggersDB1720306663437'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "login" character varying NOT NULL, "email" character varying NOT NULL, "hash" character varying NOT NULL, "createdAt" character varying NOT NULL DEFAULT '2024-07-06T22:57:47.874Z', "isConfirmed" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_16d4f7d636df336db11d87413e3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "UserTokensMetaData" ("userId" uuid NOT NULL, "confirmationCodeMetaExp" character varying NOT NULL, "recoveryTokenMetaExp" character varying NOT NULL, CONSTRAINT "PK_bf5c0455307f320c1a043d0394b" PRIMARY KEY ("userId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "UserTokensMetaData" ADD CONSTRAINT "FK_bf5c0455307f320c1a043d0394b" FOREIGN KEY ("userId") REFERENCES "Users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
